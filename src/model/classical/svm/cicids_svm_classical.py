...
joblib.dump(clf, "svm_cic_ids_model.pkl")
joblib.dump(scaler, "scaler_cic_ids.pkl")
if encoder is not None:
    joblib.dump(encoder, "encoder_cic_ids.pkl")
    print("Saved: svm_cic_ids_model.pkl, scaler_cic_ids.pkl, and encoder_cic_ids.pkl")
else:
    print("Saved: svm_cic_ids_model.pkl and scaler_cic_ids.pkl")
